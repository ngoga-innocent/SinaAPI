...
from .views import shop_products,ListOrderView,ProductCategoryView,ProductReadUpdateView,ShopCategoryListCreateView,FoodCategoryListCreateView,FoodCategoryDetailView,OrderDetailView,OrderCreateAPIView,ProductListCreateView
urlpatterns =[
