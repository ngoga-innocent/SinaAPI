...
urlpatterns=[
    ...
    path("chat-rooms/<int:pk>/", ChatRoomRetrieveDestroyView.as_view(), name="chatroom-detail"),
    path("chat-rooms/<int:chat_room_id>/messages/", MessageListCreateView.as_view(), name="message-list-create"),
